...
add_action( 'save_post', 'nova_custom_panel_save', 10, 2 );
function nova_custom_panel_save( $post_id, $post ){
	global $pagenow;
	...
	$temp_array['et_service_tabtitle'] = isset($_POST["et_service_tabtitle"]) ? sanitize_text_field($_POST["et_service_tabtitle"]) : '';
	$temp_array['et_service_tab_subtitle'] = isset($_POST["et_service_tab_subtitle"]) ? sanitize_text_field($_POST["et_service_tab_subtitle"]) : '';
	$temp_array['et_service_title'] = isset($_POST["et_service_title"]) ? wp_kses( $_POST["et_service_title"], array( 'span' => array() ) ) : '';
	$temp_array['et_service_postsnum'] = isset($_POST["et_service_postsnum"]) ? (int) $_POST["et_service_postsnum"] : '';
	$temp_array['et_service_link'] = isset($_POST["et_service_link"]) ? esc_url_raw($_POST["et_service_link"]) : '';
	$temp_array['et_settings_portfolio_categories'] = isset($_POST["et_settings_portfolio_categories"]) ? array_map( 'intval', $_POST["et_settings_portfolio_categories"] ) : '';
