...
<button class="thb-btn-edit" data-key="<?php echo $field->getName(); ?>" data-subtype="video" title="<?php _e( 'Edit slide', 'thb_text_domain' ) ?>"><?php _e( 'Edit', 'thb_text_domain' ) ?></button>
