			...
			if($part == "first" || $part == "full" ) {
				...
				if( $header_purpose == "true" ){ // header row
					...
					echo '<div class="grid_options"> 
							...
							<span class="grid_options_button header active"><span class="icon-plus-squared"></span> '.__("Show Footer Options",'rt_theme_admin').'</span>
							<span class="grid_options_button header hide hidden"><span class="icon-minus-squared"></span>  '.__("Hide Footer Options",'rt_theme_admin').'</span> 
						</div>';						
				...
				if( $header_purpose == "true" ){ // header row options
					...
					$options = array (  	 
							...
							array(
								...
								"desc"    => __('Enabled (if checked) displaying the title for this page.','rt_theme_admin'),								
