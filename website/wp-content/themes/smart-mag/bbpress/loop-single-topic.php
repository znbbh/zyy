...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="topic-meta">
		...
		<p class="bbp-topic-meta">
			...
			<span class="last-post">
				<?php _e('Last post:', 'bbPress', 'bunyad'); ?> <?php bbp_author_link( array( 'post_id' => bbp_get_topic_last_active_id(), 'type' => 'name')); ?> 
	...
	<li class="topic-activity">
		<div class="stat"><span class="number"><?php bbp_topic_voice_count(); ?></span> <?php _e('Voices', 'bbpress'); ?></div>
		
		<div class="stat"><?php echo (bbp_show_lead_topic() 
				? '<span class="number">' . bbp_get_topic_reply_count() . '</span> ' . __('Replies', 'bbPress', 'bunyad') 
				: '<span class="number">' . bbp_get_topic_post_count() . '</span> ' . __('Posts', 'bbPress', 'bunyad')); ?></div>
	</li>
