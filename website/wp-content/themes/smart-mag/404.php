		...
		<div class="col-8 main-content page">
			...
			<div class="post-content error-page row">
				...
				<div class="col-9">
					...
					<p>
					<?php _e("We're sorry, but we can't find the page you were looking for. It's probably some thing we've done wrong but now we know about it "
							."and we'll try to fix it. In the meantime, try one of these options:", 'bunyad'); ?>
					</p>
