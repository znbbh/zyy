...
<?php endif; ?>
	...
	<section class="highlights">
		...
		$query_args = array('posts_per_page' => (!empty($posts) ? intval($posts) : 4), 'order' => ($sort_order == 'asc' ? 'asc' : 'desc'));
		...
		<?php if ($count === 1): // main post - better highlighted ?>
			...
			<article itemscope itemtype="http://schema.org/Article">
				...
				<div class="meta">
					<time datetime="<?php echo get_the_date(__('Y-m-d\TH:i:sP', 'bunyad')); ?>" itempro="datePublished"><?php echo get_the_date(); ?> </time>
				...
				<div class="excerpt">
					<?php echo Bunyad::posts()->excerpt(null, 20, array('add_more' => false)); ?>
				</div>
