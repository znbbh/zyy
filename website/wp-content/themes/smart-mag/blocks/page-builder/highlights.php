...
class Bunyad_PageBuilder_Highlights extends Bunyad_PageBuilder_WidgetBase
{
	...
	{	
		...
		// supported attrs		
		$attrs = array('type', 'posts', 'cat', 'column', 'columns', 'cats', 'tags', 'headings', 'sort_by', 'sort_order');
	...
	public function form($instance)
	{
		...
		$defaults = array('posts' => 4, 'cats' => '', 'sorting' => '');
	...
	<p>
		...
		<select name="<?php echo esc_attr($this->get_field_name('sort_by')); ?>">
			<option value=""><?php _e('Published Date')?></option>
	...
	<div>
		...
		<?php wp_dropdown_categories(array(
			'show_option_all' => __('-- None - Use a Tag --', 'bunyad'), 'hierarchical' => 1, 'order_by' => 'name', 'class' => 'widefat', 'name' => $this->get_field_name('cat_1')
		)); ?>
		
		<p class="tag"><label><?php _e('or Enter a Tag:'); ?></label> <input type="text" name="<?php echo $this->get_field_name('tag_1'); ?>" value="" /></p>
	...
	<div>
		...
		<label><?php _e('Category', 'bunyad'); ?></label>
		<?php wp_dropdown_categories(array(
			'show_option_all' => __('-- None - Use a Tag --', 'bunyad'), 'hierarchical' => 1, 'order_by' => 'name', 'class' => 'widefat', 'name' => $this->get_field_name('cat_2')
		)); ?>
		
		<p class="tag"><label><?php _e('or Enter a Tag:'); ?></label> <input type="text" name="<?php echo $this->get_field_name('tag_2'); ?>" value="" /></p>
	...
	<div class="cat-3">
		...
		<label><?php _e('Category', 'bunyad'); ?></label>
		<?php wp_dropdown_categories(array(
			'show_option_all' => __('-- None - Use a Tag --', 'bunyad'), 'hierarchical' => 1, 'order_by' => 'name', 'class' => 'widefat', 'name' => $this->get_field_name('cat_3')
		)); ?>
		
		<p class="tag"><label><?php _e('or Enter a Tag:'); ?></label> <input type="text" name="<?php echo $this->get_field_name('tag_3'); ?>" value="" /></p>
