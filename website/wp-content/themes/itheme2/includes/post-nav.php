...
if ( ! themify_check( "setting-{$post_type}_nav_disable" ) ) :
	...
	$previous = get_previous_post_link( '<span class="prev">%link</span>', '%title', $in_same_cat, '', $this_taxonomy );
	$next = get_next_post_link( '<span class="next">%link</span>', '%title', $in_same_cat, '', $this_taxonomy );
