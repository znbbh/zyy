...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'main_nav_wrapper_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Menu Wrapper Background', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'background',
		...
		'main_nav_wrapper_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Menu Wrapper Border', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'border',
		...
		'main_nav_wrapper_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Menu Wrapper Padding', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'padding',
		...
		'main_nav_wrapper_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Menu Wrapper Margin', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#nav-bar',
			'prop' => 'margin',
		...
		// Accordion Start ---------------------------
		'start_slider_acc' => $themify_customizer->accordion_start( __( 'Header Slider', 'themify' ) ),

		'sliderwrap_background' => array(
			'control' => array(
				'type'    => 'Themify_Background_Control',
				'label'   => __( 'Slider Wrap Background', 'themify' ),
			),
			'selector' => '#header-slider',
			'prop' => 'background',
		),
		
		'sliderwrap_border' => array(
			'control' => array(
				'type'    => 'Themify_Border_Control',
				'label'   => __( 'Slider Wrap Border', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#header-slider',
			'prop' => 'border',
		...
		'sliderwrap_padding' => array(
			'control' => array(
				'type'    => 'Themify_Padding_Control',
				'label'   => __( 'Slider Wrap Padding', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#header-slider',
			'prop' => 'padding',
		...
		'sliderwrap_margin' => array(
			'control' => array(
				'type'    => 'Themify_Margin_Control',
				'label'   => __( 'Slider Wrap Margin', 'themify' ),
				'show_label' => false,
			),
			'selector' => '#header-slider',
			'prop' => 'margin',
		...
		'end_slider_acc' => $themify_customizer->accordion_end(),
		// Accordion End   ---------------------------
