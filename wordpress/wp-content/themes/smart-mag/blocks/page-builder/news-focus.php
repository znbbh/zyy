...
class Bunyad_PageBuilder_NewsFocus extends Bunyad_PageBuilder_WidgetBase
{
	...
	public function widget($args, $instance)
	{
		...
		// supported attrs
		$attrs = array('posts', 'cat', 'tax_tag', 'sub_cats', 'sub_tags', 'sort_order', 'sort_by', 'highlights');
	...
	<p>
		...
		<?php wp_dropdown_categories(array(
			'show_option_all' => __('-- None - Use a Tag --', 'bunyad'), 'hierarchical' => 1, 'order_by' => 'name', 'class' => 'widefat', 'name' => $this->get_field_name('cat'))); ?>
	</p>
