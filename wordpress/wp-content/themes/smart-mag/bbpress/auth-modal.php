		...
		<div class="modal-content main-screen">
			...
			<?php if (!is_user_logged_in()): ?>
					...
					<fieldset>
						...
						<div class="bbp-username input-group">
							...
							<input type="text" name="log" value="" size="20" id="user_login" tabindex="1" 
								placeholder="<?php esc_attr_e('Your Username', 'bbPress', 'bunyad'); ?>" />
						</div>
	
						<div class="bbp-password input-group">
							<i class="fa fa-lock"></i>
							<input type="password" name="pwd" value="" size="20" id="user_pass" tabindex="2" 
								placeholder="<?php esc_attr_e('Your Password', 'bbPress', 'bunyad'); ?>"/>
						</div>
				...
				<div class="bbp-register-info"><?php _e("Don't have an account?", 'bbPress', 'bunyad'); ?>
					<a href="#" class="register-modal"><?php _e('Register Now!', 'bbPress', 'bunyad'); ?></a>
				</div>
			...
			<?php else: ?>
				...
				?>
					...
					<?php _e('Welcome back, ', 'bbPress', 'bunyad'); ?> <?php echo esc_html($current->name); ?>
					...
					<fieldset>
						...
						<div class="bbp-password input-group">
							...
							<input type="text" name="user_login" value="" size="20" id="user_login" tabindex="1" 
								placeholder="<?php esc_attr_e('Username or Email', 'bbPress', 'bunyad'); ?>"/>
						</div>
					...
					<fieldset>
						...
						<div class="bbp-password input-group">
							...
							<input type="text" name="user_email" value="" size="20" id="user_email" tabindex="2" 
								placeholder="<?php esc_attr_e('Your Email', 'bbPress', 'bunyad'); ?>"/>
						</div>
