				...
				<div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<p>
							...
							<input type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_tags" class="form-control" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
						</p>
					...
					<div class="bbp-submit-wrapper text-right">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button btn btn-primary submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
