...
<div class="thb-modal-fields-container thb-fields-container duplicable <?php echo $fields_container->isSortable() ? 'sortable' : ''; ?> <?php echo count($fields) == 0 ? 'no-fields' : ''; ?>" id="thb-modal-fields-container-<?php echo $fields_container->getSlug(); ?>" data-slug="<?php echo $fields_container->getSlug(); ?>" data-field-key="<?php echo $fields_container->getField()->getName(); ?>">
