...
if( ! function_exists( 'thb_theme_portfolio_options' ) ) {
	...
	function thb_theme_portfolio_options() {
		if( thb_is_admin_template( 'template-portfolio.php' ) ) {
			...
			$thb_metabox = thb_theme()->getPostType( 'page' )->getMetabox( 'portfolio_options' );
...
if( !function_exists('thb_builder_load') ) {
	...
	add_action( 'thb_page_content_start', 'thb_builder_load' );
	add_action( 'thb_single_content_start', 'thb_builder_load' );
}
...
if ( ! function_exists( 'thb_thumbnails_open_posts' ) ) {
	...
	function thb_thumbnails_open_posts() {
		...
		if ( thb_is_admin_template( $templates ) ) {
			$metabox = thb_theme()->getPostType( 'page' )->getMetabox( 'loop' );
	...
	add_action( 'wp_loaded', 'thb_thumbnails_open_posts' );
}
