...
$thb_customizer = thb_theme()->setCustomizer( new THB_Customizer() );
	...
	$thb_main = $thb_customizer->addSection( 'main', __( 'Theme style', 'thb_text_domain' ) );
		...
		if ( function_exists( 'is_woocommerce' ) && function_exists( 'thb_woocommerce_check' ) ) {
			$color .= ', .thb_mini_cart_wrapper a:hover, .woocommerce-page .woocommerce-pagination li .current, .woocommerce .woocommerce-pagination li .current, .woocommerce-page.single-product .summary .thb-product-header .woocommerce-breadcrumb a:hover';
