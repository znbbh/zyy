...
<div class="thb-content-share">
	...
	<ul>
		...
		<li>
			<a data-type="thb-pinterest" href="//pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php echo $src[0]; ?>&description=<?php the_title(); ?>" target="_blank" class="thb-content-share-pinterest">
				<span>
		...
		<li>
			<a data-type="thb-twitter" href="http://twitter.com/home?status=<?php the_title(); ?> <?php the_permalink(); ?>" target="_blank" class="thb-content-share-twitter">
				<span>
		...
		<li>
			<a data-type="thb-email" target="_blank" href="mailto:entertheaddress@example.com?subject=<?php the_title(); ?>&body=<?php the_permalink(); ?>" class="thb-content-share-email">
				<span>
