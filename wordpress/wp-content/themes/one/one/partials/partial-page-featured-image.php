...
// if ( $is_layerslider || thb_slideshow_has_slides() || ! empty( $featured_image ) || ! empty( $header_background ) || ! empty( $header_background_color ) ) {
// 	$show_slideshow = true;
// }

// if ( $show_slideshow ) {
// 	if ( thb_get_layerslider() != '' ) {
...
// 		$slideshow_attrs = array( 'style' => '' );

// 		if ( ! empty( $header_background_color ) ) {
// 			$slideshow_attrs['style'] .= sprintf( ' background-color: %s;', $header_background_color );
// 		}

// 		echo '<div class="thb-slideshow rsTHB thb-main-slideshow ' . $slideshow_class . '" ' . thb_get_attributes( $slideshow_attrs ) . '>';

// 			$slide_attrs = array( 'style' => '' );

// 			if ( ! empty( $header_background ) ) {
// 				$slide_attrs['style'] .= sprintf( ' background-image: url(%s);', $header_background );
// 			}
// 			elseif ( ! empty( $featured_image ) ) {
// 				if ( thb_is_page_header_layout_extended() ) {
// 					$slide_attrs['style'] .= sprintf( ' background-image: url(%s);', $featured_image );
// 				}
// 			}
