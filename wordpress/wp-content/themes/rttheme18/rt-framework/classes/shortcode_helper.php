			...
			"product_box" => array(
				...
				"parameters" => array(
									...
									array(
										...
										"desc"=> __("Romoves top borders of first row of the grid",'rt_theme_admin'),
										"possible_values" => array(
																''=>__('leave blank for false','rt_theme_admin'),
																'true'=>__('True','rt_theme_admin'), 
															),
									...
									array(
										...
										"desc"=> __("Romoves bottom borders of last row of the grid",'rt_theme_admin'),
										"possible_values" => array(
																''=>__('leave blank for false','rt_theme_admin'),
																'true'=>__('True','rt_theme_admin'), 
															),
	...
	*/
	...
	public function custom_toolbar() {
		...
		$args = array(
			...
			'title'  => '<div><span class="icon-code"></span>'.__( 'Shortcodes', 'rt_theme_admin' ) .'</div>',		
			'group'  => false 
		);
	...
	private function create_shortcode_list() {   
