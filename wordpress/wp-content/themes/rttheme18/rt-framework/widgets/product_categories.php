...
class RT_Product_Categories extends WP_Widget {
	...
	function RT_Product_Categories() {
		...
		$this->WP_Widget('rt_product_categories', '['. RT_THEMENAME.']   '.__('Product Categories ', 'rt_theme_admin'), $opts);
	}
	...
	function widget( $args, $instance ) {
		...
		$show_product_counts	= $instance['show_product_counts']; 
