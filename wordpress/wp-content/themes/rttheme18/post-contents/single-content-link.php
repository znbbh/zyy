	...
	<section class="article_info article_section <?php if( $rt_list_style != "style1" ):?>with_icon<?php endif;?>">
		...
		<div class="blog-head-line clearfix">    
			...
			<div class="post-title-holder">
				...
				<!-- blog headline-->
				<?php if( $rt_list_style == "style2" ):?><h2 class="icon-link"><?php else:?><h2><?php endif;?><?php the_title('',': '); ?><?php echo '<a href="'.$post_format_link.'"  target="_blank" title="">'.$post_format_link.'</a>'?></h2> 
				<!-- / blog headline--> 
