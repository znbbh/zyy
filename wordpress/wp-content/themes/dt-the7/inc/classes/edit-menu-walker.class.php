 ...
 */
class Dt_Edit_Menu_Walker extends Walker_Nav_Menu {
	/**
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( !empty($item->dt_mega_menu_enabled) ) {
			$classes[] = 'field-dt-mega-menu-enabled';
		}
		switch ( $item->dt_mega_menu_icon ) {
			case 'image': $mega_menu_container_classes[] = 'field-dt-mega-menu-image-icon'; break;
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<div class="<?php echo esc_attr( $mega_menu_container_classes ); ?>">
					...
					<p class="field-dt-icon description description-wide">
						<?php _ex( 'Icon :', 'edit menu walker', LANGUAGE_ZONE ); ?>
						<label>
					...
					<div class="field-dt-image controls">
						<?php
						if ( function_exists('optionsframework_uploader') ) {
							echo optionsframework_uploader( 'menu-item-dt-image-' . $item_id, $item->dt_mega_menu_image, 'uri_only', null, "menu-item-dt-image[{$item_id}]" );
						}
						?>
					</div>
					...
					<p class="field-dt-fullwidth-menu">
						<label for="edit-menu-item-dt-fullwidth-menu-<?php echo $item_id; ?>">
							...
							<?php _ex( 'Fullwidth', 'edit menu walker', LANGUAGE_ZONE ); ?>
						</label>
					</p>
					...
					<p class="field-dt-hide-title">
						<label for="edit-menu-item-dt-hide-title-<?php echo $item_id; ?>">
							...
							<?php _ex( 'Hide title in mega menu', 'edit menu walker', LANGUAGE_ZONE ); ?>
						</label>
					</p>
					<p class="field-dt-remove-link">
						<label for="edit-menu-item-dt-remove-link-<?php echo $item_id; ?>">
							...
							<?php _ex( 'Remove link', 'edit menu walker', LANGUAGE_ZONE ); ?>
						</label>
					</p>
					...
					<p class="field-dt-new-column">
						<label for="edit-menu-item-dt-new-column-<?php echo $item_id; ?>">
							...
							<?php _ex( 'This item should start a new column', 'edit menu walker', LANGUAGE_ZONE ); ?>
						</label>
					</p>
