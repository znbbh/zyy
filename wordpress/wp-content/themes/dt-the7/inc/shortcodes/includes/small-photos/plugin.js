(function() {
	var command_name = 'dt_mce_command-small_photos',
		plugin_name = 'dt_mce_plugin_shortcode_small_photos',
		plugin_title = 'Small photos',
		plugin_image = 'photos-slideshow.png';
	...
	tinymce.create( 'tinymce.plugins.' + plugin_name, {		 
		init : function( ed, url ) {
			...
			ed.addCommand(command_name, function() {
				...
				return_text = '[dt_small_photos ' + attr_str + ' /]';
